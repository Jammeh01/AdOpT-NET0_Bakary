...
input_data_path = script_dir / "macro_decarbonisation"
...
node_alt = {'northwest': 120, 'northeast': 50,'center': 250, 'south': 200, 'islands': 0}
...
technologies["new"] = ["HeatPump_AirSourced", "Storage_Battery", "Storage_H2"]
technologies["existing"] = {"Hydro_Reservoir": 74460000, "GasTurbine_simple": 12000, "Boiler_Small_NG": 4500}
...
with open(input_data_path / "period1" / "node_data" / "northeast" / "Technologies.json", "r") as json_file:
    technologies = json.load(json_file)
technologies["new"] = ["HeatPump_AirSourced", "Storage_Battery", "Storage_H2"]
technologies["existing"] = {"Hydro_Reservoir": 24528000, "GasTurbine_simple": 8500, "Boiler_Small_NG": 3800}
...
with open(input_data_path / "period1" / "node_data" / "center" / "Technologies.json", "r") as json_file:
    technologies = json.load(json_file)
technologies["new"] = ["HeatPump_AirSourced", "Storage_Battery", "Storage_H2"]
technologies["existing"] = {"Hydro_Reservoir": 73584000, "GasTurbine_simple": 9200, "Boiler_Small_NG": 3200}
...
with open(input_data_path / "period1" / "node_data" / "south" / "Technologies.json", "r") as json_file:
    technologies = json.load(json_file)
technologies["new"] = ["HeatPump_AirSourced", "Storage_Battery", "Storage_H2"]
technologies["existing"] = {"Hydro_Reservoir": 45552000, "GasTurbine_simple": 7800, "Boiler_Small_NG": 2400}  # MWth and MWe
...
with open(input_data_path / "period1" / "node_data" / "islands" / "Technologies.json", "r") as json_file:
    technologies = json.load(json_file)
technologies["new"] = ["HeatPump_AirSourced", "Storage_Battery", "Storage_H2"]
technologies["existing"] = {"Hydro_Reservoir": 18396000, "GasTurbine_simple": 3200, "Boiler_Small_NG": 800}  # MWth and MWe
